...
def provider_throttle_map():
    return {
        ...
        "fileflows": {
            ConnectionError: (datetime.timedelta(hours=1), "1 hour"),
        },
    }
...
def get_providers_auth():
    return {
        ...
        "fileflows": {
            "api_url": settings.fileflows.api_url,
            "api_key": settings.fileflows.api_key,
            "workflow_id": settings.fileflows.workflow_id,
            "timeout": settings.fileflows.timeout,
            "loglevel": settings.fileflows.loglevel,
        },
    }
